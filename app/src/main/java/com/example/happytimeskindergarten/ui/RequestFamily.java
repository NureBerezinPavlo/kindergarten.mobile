...
public interface RequestFamily {
    ...
    @Headers("Accept: application/json;charset=UTF-8")
    Call<family_accountData> updateParent(@Path("id") String id, @Header("Authorization") String token, @Field("user_id") String user_id, @Field("phone_number") String phone, @Field("image") String image);
}
